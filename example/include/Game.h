...
interface (Game, Start,         char*, (Game* const));
 ...
 */
function objc_loadGame(Class super) 
{
 ...
 * 
 */
function GLboolean CheckCollision2(Game* this, GameObject* one, GameObject* two) // AABB - AABB collision
{
    // Collision x-axis?
 ...
 * ToString
 */
method char* ToString(const Game* const this)
{
    return "Game";
}
